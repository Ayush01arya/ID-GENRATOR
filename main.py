...
if st.button("CREATE"):
    ...
    color = 'rgb(0, 0, 0)'  # black color
    draw.text((x, y), message5, fill=color, font=font)

    (x, y) = (50, 550)

    color = 'rgb(255, 0, 0)'  # black color
    draw.text((x, y), message6, fill=color, font=font)

    (x, y) = (50, 650)

    color = 'rgb(0, 0, 0)'  # black color
    draw.text((x, y), message7, fill=color, font=font)

    (x, y) = (50, 750)

    color = 'rgb(0, 0, 0)'  # black color
    draw.text((x, y), message8, fill=color, font=font)
